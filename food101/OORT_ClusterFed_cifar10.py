...
def main():
    ...
    results_as_list = os.path.join(result_directory, 'output_cifar10_' + "oort_" + args.selection_mode + '_dirichlet_NEW_NonCluster.txt')
    configs_as_list = os.path.join(result_directory, 'output_cifar10_' + "oort_" + args.selection_mode + '_dirichlet_args_NEW_NonCluster.txt')
