...
import client_fmnist as client_obj
from server_custom_fmnist import Server, download_cifar10
import csv
...
weight = 0.4
D = 0.11 # Example deadline for transmission time (in seconds)
...
def main():
    ...
    train_dataset = datasets.FashionMNIST('/home/kamrul/Documents/kamrul_files_Linux/OORT/ClusterFed_OORT/food101/data', train=True, download=False, transform=transform)
    test_dataset = datasets.FashionMNIST('/home/kamrul/Documents/kamrul_files_Linux/OORT/ClusterFed_OORT/food101/data', train=False, transform=transform)
    ...
    results_as_list = os.path.join(result_directory, 'output_fmnist_'+client_select_type+'_'+selection_scope+'_vrf'+str(VRF_scope)+'_dirichlet_Q8_lr0.01_ep1_w0.4.txt') 
