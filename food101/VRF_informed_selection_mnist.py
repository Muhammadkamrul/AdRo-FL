...
import client_VRF_mnist as client_obj
from server_vrf_custom_mnist import Server
import os
...
def main():
    ...
    results_as_list = os.path.join(result_directory, 'output_mnist_'+client_select_type+'_global_dirichlet_Q8_lr0.01_ep1_w0.4_vrf_UtilitySigned.txt') 
