...
def main():
    ...
    results_as_list = os.path.join(result_directory, 'output_cifar10_'+client_select_type+ '_' + selection_scope +'_vrf'+str(VRF_scope)+'_dirichlet_Q8_lr0.01_ep1_w0.4.txt') 
