...
import client_VRF_fmnist as client_obj
from server_vrf_custom_fmnist import Server
import os
...
def main():
    ...
    results_as_list = os.path.join(result_directory, 'output_fmnist_'+client_select_type+'_global_dirichlet_Q8_lr0.01_ep1_w0.4_vrf_UtilitySigned.txt') 
