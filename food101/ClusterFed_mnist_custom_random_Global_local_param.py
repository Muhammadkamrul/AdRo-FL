...
import client_mnist as client_obj
from server_custom_mnist import Server, download_cifar10
import csv
...
def main():
    ...
    results_as_list = os.path.join(result_directory, 'output_mnist_'+client_select_type+'_'+selection_scope+'_vrf'+str(VRF_scope)+'_dirichlet_Q8_lr0.01_ep1_w0.4_tmp_del.txt') 
