...
def main():
    ...
    results_as_list = os.path.join(result_directory, 'output_svhn_' + "oort_" + args.selection_mode + '_dirichlet_NEW_NonCluster.txt')
    configs_as_list = os.path.join(result_directory, 'output_svhn_' + "oort_" + args.selection_mode + '_dirichlet_args_NEW_NonCluster.txt')
    ...
    test_dataset = datasets.SVHN('/home/kamrul/Documents/kamrul_files_Linux/OORT/ClusterFed_OORT/food101/data', split='test', download=False, transform=transform)
